...
|------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|
| TOP_DESCRIPTOR   | Description of the DSP process to apply, starting with the index of the secondary source used to compute against the current buffer data,<br>followed by the operation opcode and the k register value                    | `(index << 28 \| opcode << 8 \| k)` |
...
| TOP_SRC          | Routing to the 'top' source targeted by the current Process Element,<br>including the offset (in words) from where to start                                                                                               | `(routing << 16 \| offset)`         |
...
| TOP_PARAM_3      | Additional local process applied on the 'top' source:<br>sync, unknown, depends on the local config                                                                                                                       | `(config << 16 \| value)`           |
| BASE_DESCRIPTOR  | Description of the DSP process to apply on the base source, starting with the index of the secondary source used to compute against the current buffer data,<br>followed by the operation opcode and the k register value | `(index << 28 \| opcode << 8 \| k)` |
...
| BASE_SRC         | Routing to the 'base' source targeted by the current Process Element,<br>including the offset (in words) from where to start                                                                                              | `(routing << 16 \| offset)`         |
...
| DST              | Routing to the destination targeted by the current Process Element,<br>including the offset (in words) from where to start                                                                                                | `(routing << 16 \| offset)`         |
